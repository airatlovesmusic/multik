package com.airatlovesmusic.feature_article_impl.ui

import android.os.Bundle
import android.view.View
import androidx.core.os.bundleOf
import androidx.lifecycle.Observer
import com.airatlovesmusic.feature_article_impl.R
import com.airatlovesmusic.feature_article_impl.di.ArticleFeatureComponent
...
class DetailArticleFragment: BaseFragment<DetailArticleViewModel>() {
    ...
    override fun inject() {
        DaggerArticleFeatureComponent.create()
